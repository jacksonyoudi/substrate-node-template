...
class PortableRegistry extends types_codec_1.Struct {
    constructor(registry, value, isContract) {
        ...
        tslib_1.__classPrivateFieldSet(this, _PortableRegistry_alias, extractAliases(params, isContract), "f");
        tslib_1.__classPrivateFieldSet(this, _PortableRegistry_lookups, lookups, "f");
        tslib_1.__classPrivateFieldSet(this, _PortableRegistry_names, names, "f");
        tslib_1.__classPrivateFieldSet(this, _PortableRegistry_params, params, "f");
        tslib_1.__classPrivateFieldSet(this, _PortableRegistry_types, types, "f");
     ...
     **/
    get names() {
        return Object.values(tslib_1.__classPrivateFieldGet(this, _PortableRegistry_names, "f")).sort();
    }
    /**
     ...
     */
    register() {
        registerTypes(this, tslib_1.__classPrivateFieldGet(this, _PortableRegistry_lookups, "f"), tslib_1.__classPrivateFieldGet(this, _PortableRegistry_names, "f"), tslib_1.__classPrivateFieldGet(this, _PortableRegistry_params, "f"));
    }
    /**
     * @description Returns the name for a specific lookup
     */
    getName(lookupId) {
        return tslib_1.__classPrivateFieldGet(this, _PortableRegistry_names, "f")[tslib_1.__classPrivateFieldGet(this, _PortableRegistry_instances, "m", _PortableRegistry_getLookupId).call(this, lookupId)];
    }
    /**
    ...
    getSiType(lookupId) {
        ...
        const found = (tslib_1.__classPrivateFieldGet(this, _PortableRegistry_types, "f") || this.types)[tslib_1.__classPrivateFieldGet(this, _PortableRegistry_instances, "m", _PortableRegistry_getLookupId).call(this, lookupId)];
        if (!found) {
     ...
     */
    getTypeDef(lookupId) {
        const lookupIndex = tslib_1.__classPrivateFieldGet(this, _PortableRegistry_instances, "m", _PortableRegistry_getLookupId).call(this, lookupId);
        if (!tslib_1.__classPrivateFieldGet(this, _PortableRegistry_typeDefs, "f")[lookupIndex]) {
            const lookupName = tslib_1.__classPrivateFieldGet(this, _PortableRegistry_names, "f")[lookupIndex];
            const empty = {
            ...
            if (lookupName) {
                tslib_1.__classPrivateFieldGet(this, _PortableRegistry_typeDefs, "f")[lookupIndex] = empty;
            }
            const extracted = tslib_1.__classPrivateFieldGet(this, _PortableRegistry_instances, "m", _PortableRegistry_extract).call(this, this.getSiType(lookupId), lookupIndex);
            ...
            Object.keys(extracted).forEach((k) => {
                if (k !== 'lookupName' || extracted[k]) {
                    ...
                    tslib_1.__classPrivateFieldGet(this, _PortableRegistry_typeDefs, "f")[lookupIndex][k] = extracted[k];
                }
            });
            // don't set lookupName on lower-level, we want to always direct to the type
            if (extracted.info === types_create_1.TypeDefInfo.Plain) {
                tslib_1.__classPrivateFieldGet(this, _PortableRegistry_typeDefs, "f")[lookupIndex].lookupNameRoot = tslib_1.__classPrivateFieldGet(this, _PortableRegistry_typeDefs, "f")[lookupIndex].lookupName;
                delete tslib_1.__classPrivateFieldGet(this, _PortableRegistry_typeDefs, "f")[lookupIndex].lookupName;
            }
        }
        return tslib_1.__classPrivateFieldGet(this, _PortableRegistry_typeDefs, "f")[lookupIndex];
    }
    /**
...
_PortableRegistry_alias = new WeakMap(), _PortableRegistry_lookups = new WeakMap(), _PortableRegistry_names = new WeakMap(), _PortableRegistry_params = new WeakMap(), _PortableRegistry_typeDefs = new WeakMap(), _PortableRegistry_types = new WeakMap(), _PortableRegistry_instances = new WeakSet(), _PortableRegistry_createSiDef = function _PortableRegistry_createSiDef(lookupId) {
    ...
    return [types_create_1.TypeDefInfo.DoNotConstruct, types_create_1.TypeDefInfo.Enum, types_create_1.TypeDefInfo.Struct].includes(typeDef.info) && typeDef.lookupName
        ? {
            ...
            lookupIndex,
            lookupName: tslib_1.__classPrivateFieldGet(this, _PortableRegistry_names, "f")[lookupIndex],
    ...
    let typeDef;
    const aliasType = tslib_1.__classPrivateFieldGet(this, _PortableRegistry_alias, "f")[lookupIndex] || getAliasPath(type);
    try {
        if (aliasType) {
            typeDef = tslib_1.__classPrivateFieldGet(this, _PortableRegistry_instances, "m", _PortableRegistry_extractAliasPath).call(this, lookupIndex, aliasType);
        }
        else {
            switch (type.def.type) {
                case 'Array':
                    typeDef = tslib_1.__classPrivateFieldGet(this, _PortableRegistry_instances, "m", _PortableRegistry_extractArray).call(this, lookupIndex, type.def.asArray);
                    break;
                case 'BitSequence':
                    typeDef = tslib_1.__classPrivateFieldGet(this, _PortableRegistry_instances, "m", _PortableRegistry_extractBitSequence).call(this, lookupIndex, type.def.asBitSequence);
                    break;
                case 'Compact':
                    typeDef = tslib_1.__classPrivateFieldGet(this, _PortableRegistry_instances, "m", _PortableRegistry_extractCompact).call(this, lookupIndex, type.def.asCompact);
                    break;
                case 'Composite':
                    typeDef = tslib_1.__classPrivateFieldGet(this, _PortableRegistry_instances, "m", _PortableRegistry_extractComposite).call(this, lookupIndex, type, type.def.asComposite);
                    break;
                case 'HistoricMetaCompat':
                    typeDef = tslib_1.__classPrivateFieldGet(this, _PortableRegistry_instances, "m", _PortableRegistry_extractHistoric).call(this, lookupIndex, type.def.asHistoricMetaCompat);
                    break;
                case 'Primitive':
                    typeDef = tslib_1.__classPrivateFieldGet(this, _PortableRegistry_instances, "m", _PortableRegistry_extractPrimitive).call(this, lookupIndex, type);
                    break;
                case 'Sequence':
                    typeDef = tslib_1.__classPrivateFieldGet(this, _PortableRegistry_instances, "m", _PortableRegistry_extractSequence).call(this, lookupIndex, type.def.asSequence);
                    break;
                case 'Tuple':
                    typeDef = tslib_1.__classPrivateFieldGet(this, _PortableRegistry_instances, "m", _PortableRegistry_extractTuple).call(this, lookupIndex, type.def.asTuple);
                    break;
                case 'Variant':
                    typeDef = tslib_1.__classPrivateFieldGet(this, _PortableRegistry_instances, "m", _PortableRegistry_extractVariant).call(this, lookupIndex, type, type.def.asVariant);
                    break;
    ...
    return (0, types_create_1.withTypeString)(this.registry, {
        ...
        length,
        sub: tslib_1.__classPrivateFieldGet(this, _PortableRegistry_instances, "m", _PortableRegistry_createSiDef).call(this, type)
    });
    ...
    const a = tslib_1.__classPrivateFieldGet(this, _PortableRegistry_instances, "m", _PortableRegistry_createSiDef).call(this, bitOrderType);
    const b = tslib_1.__classPrivateFieldGet(this, _PortableRegistry_instances, "m", _PortableRegistry_createSiDef).call(this, bitStoreType);
    ...
    if (path.length) {
        ...
        if (path.length === 1 && pathFirst === 'BTreeMap') {
            ...
            return (0, types_create_1.withTypeString)(this.registry, {
                ...
                sub: params.map(({ type }) => tslib_1.__classPrivateFieldGet(this, _PortableRegistry_instances, "m", _PortableRegistry_createSiDef).call(this, type.unwrap()))
            });
        }
            ...
            return (0, types_create_1.withTypeString)(this.registry, {
                ...
                sub: tslib_1.__classPrivateFieldGet(this, _PortableRegistry_instances, "m", _PortableRegistry_createSiDef).call(this, params[0].type.unwrap())
            });
        }
    ...
    return PATHS_SET.some((p) => matchParts(p, path))
        ? tslib_1.__classPrivateFieldGet(this, _PortableRegistry_instances, "m", _PortableRegistry_extractCompositeSet).call(this, lookupIndex, params, fields)
        : tslib_1.__classPrivateFieldGet(this, _PortableRegistry_instances, "m", _PortableRegistry_extractFields).call(this, lookupIndex, fields);
    ...
    if (fields.length === 0) {
        ...
        const typeDef = tslib_1.__classPrivateFieldGet(this, _PortableRegistry_instances, "m", _PortableRegistry_createSiDef).call(this, fields[0].type);
    ...
    const [sub, alias] = tslib_1.__classPrivateFieldGet(this, _PortableRegistry_instances, "m", _PortableRegistry_extractFieldsAlias).call(this, fields);
    ...
    for (let i = 0; i < fields.length; i++) {
        ...
        const typeDef = tslib_1.__classPrivateFieldGet(this, _PortableRegistry_instances, "m", _PortableRegistry_createSiDef).call(this, type);
        if (name.isNone) {
            sub[i] = typeDef;
        }
        else {
    ...
    const sub = tslib_1.__classPrivateFieldGet(this, _PortableRegistry_instances, "m", _PortableRegistry_createSiDef).call(this, type);
    if (sub.type === 'u8') {
        return {
            info: types_create_1.TypeDefInfo.Plain,
            type: 'Bytes'
    ...
    const sub = ids.map((t) => tslib_1.__classPrivateFieldGet(this, _PortableRegistry_instances, "m", _PortableRegistry_createSiDef).call(this, t));
    return (0, types_create_1.withTypeString)(this.registry, {
        ...
        if (specialVariant === 'Option') {
            ...
            return (0, types_create_1.withTypeString)(this.registry, {
                ...
                sub: params.map(({ type }, index) => (0, util_1.objectSpread)({
                    name: ['Ok', 'Error'][index]
                }, tslib_1.__classPrivateFieldGet(this, _PortableRegistry_instances, "m", _PortableRegistry_createSiDef).call(this, type.unwrap())))
            });
        }
    }
    ...
    return tslib_1.__classPrivateFieldGet(this, _PortableRegistry_instances, "m", _PortableRegistry_extractVariantEnum).call(this, lookupIndex, variants);
    ...
    variants
        ...
        sub.push((0, util_1.objectSpread)(tslib_1.__classPrivateFieldGet(this, _PortableRegistry_instances, "m", _PortableRegistry_extractFields).call(this, -1, fields), {
            index,
            name: name.toString()
        }));
    });
