...
exports.runtime = {
    ParachainHost: [
        {
            methods: (0, util_1.objectSpread)({}, PH_V1_TO_V2, PH_V2_TO_V3, PH_V3, PH_V4),
            version: 4
        },
        {
            methods: (0, util_1.objectSpread)({}, PH_V1_TO_V2, PH_V2_TO_V3, PH_V3),
            version: 3
        },
        {
            methods: (0, util_1.objectSpread)({}, PH_V1_TO_V2, PH_V2_TO_V3),
            version: 2
        },
        {
            methods: (0, util_1.objectSpread)({
                session_info: {
                    description: 'Get the session info for the given session, if stored.',
                    params: [
                        {
