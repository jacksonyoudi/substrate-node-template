...
class InnerChecker {
    constructor(healthCallback, requestToSmoldot) {
        ...
        this.sendJsonRpc = (request) => {
            ...
            tslib_1.__classPrivateFieldGet(this, _InnerChecker_requestToSmoldot, "f").call(this, parsedRequest);
        };
        this.responsePassThrough = (jsonRpcResponse) => {
            ...
            if (parsedResponse.id && tslib_1.__classPrivateFieldGet(this, _InnerChecker_currentHealthCheckId, "f") === parsedResponse.id) {
                tslib_1.__classPrivateFieldSet(this, _InnerChecker_currentHealthCheckId, null, "f");
                ...
                tslib_1.__classPrivateFieldGet(this, _InnerChecker_healthCallback, "f").call(this, parsedResponse.result);
                tslib_1.__classPrivateFieldSet(this, _InnerChecker_isSyncing, parsedResponse.result.isSyncing, "f");
                this.update(false);
                return null;
            }
            // Check whether response is a response to the subscription or unsubscription.
            if (parsedResponse.id &&
                tslib_1.__classPrivateFieldGet(this, _InnerChecker_currentSubunsubRequestId, "f") === parsedResponse.id) {
                tslib_1.__classPrivateFieldSet(this, _InnerChecker_currentSubunsubRequestId, null, "f");
                // Check whether query was successful. It is possible for queries to fail for
                // various reasons, such as the client being overloaded.
                if (!parsedResponse.result) {
                    this.update(false);
                ...
                if (tslib_1.__classPrivateFieldGet(this, _InnerChecker_currentSubscriptionId, "f")) {
                    tslib_1.__classPrivateFieldSet(this, _InnerChecker_currentSubscriptionId, null, "f");
                }
                else {
                    tslib_1.__classPrivateFieldSet(this, _InnerChecker_currentSubscriptionId, parsedResponse.result, "f");
                }
                this.update(false);
                return null;
            }
            ...
            if (parsedResponse.params &&
                tslib_1.__classPrivateFieldGet(this, _InnerChecker_currentSubscriptionId, "f") &&
                parsedResponse.params.subscription === tslib_1.__classPrivateFieldGet(this, _InnerChecker_currentSubscriptionId, "f")) {
        ...
        this.update = (startNow) => {
            ...
            if (startNow && tslib_1.__classPrivateFieldGet(this, _InnerChecker_currentHealthTimeout, "f")) {
                clearTimeout(tslib_1.__classPrivateFieldGet(this, _InnerChecker_currentHealthTimeout, "f"));
                tslib_1.__classPrivateFieldSet(this, _InnerChecker_currentHealthTimeout, null, "f");
            }
            if (!tslib_1.__classPrivateFieldGet(this, _InnerChecker_currentHealthTimeout, "f")) {
                const startHealthRequest = () => {
                    ...
                    if (tslib_1.__classPrivateFieldGet(this, _InnerChecker_currentHealthCheckId, "f")) {
                        return;
                    }
                    // Actual request starting.
                    tslib_1.__classPrivateFieldSet(this, _InnerChecker_currentHealthCheckId, `health-checker:${tslib_1.__classPrivateFieldGet(this, _InnerChecker_nextRequestId, "f")}`, "f");
                    tslib_1.__classPrivateFieldSet(this, _InnerChecker_nextRequestId, tslib_1.__classPrivateFieldGet(this, _InnerChecker_nextRequestId, "f") + 1, "f");
                    tslib_1.__classPrivateFieldGet(this, _InnerChecker_requestToSmoldot, "f").call(this, {
                        id: tslib_1.__classPrivateFieldGet(this, _InnerChecker_currentHealthCheckId, "f"),
                        jsonrpc: '2.0',
                ...
                if (startNow) {
                    ...
                    tslib_1.__classPrivateFieldSet(this, _InnerChecker_currentHealthTimeout, setTimeout(startHealthRequest, 1000), "f");
                }
            }
            if (tslib_1.__classPrivateFieldGet(this, _InnerChecker_isSyncing, "f") &&
                !tslib_1.__classPrivateFieldGet(this, _InnerChecker_currentSubscriptionId, "f") &&
                !tslib_1.__classPrivateFieldGet(this, _InnerChecker_currentSubunsubRequestId, "f")) {
        ...
        this.startSubscription = () => {
            if (tslib_1.__classPrivateFieldGet(this, _InnerChecker_currentSubunsubRequestId, "f") || tslib_1.__classPrivateFieldGet(this, _InnerChecker_currentSubscriptionId, "f")) {
                throw new Error('Internal error in health checker');
            }
            tslib_1.__classPrivateFieldSet(this, _InnerChecker_currentSubunsubRequestId, `health-checker:${tslib_1.__classPrivateFieldGet(this, _InnerChecker_nextRequestId, "f")}`, "f");
            tslib_1.__classPrivateFieldSet(this, _InnerChecker_nextRequestId, tslib_1.__classPrivateFieldGet(this, _InnerChecker_nextRequestId, "f") + 1, "f");
            tslib_1.__classPrivateFieldGet(this, _InnerChecker_requestToSmoldot, "f").call(this, {
                id: tslib_1.__classPrivateFieldGet(this, _InnerChecker_currentSubunsubRequestId, "f"),
                jsonrpc: '2.0',
        ...
        this.endSubscription = () => {
            ...
            tslib_1.__classPrivateFieldGet(this, _InnerChecker_requestToSmoldot, "f").call(this, {
                ...
                params: [tslib_1.__classPrivateFieldGet(this, _InnerChecker_currentSubscriptionId, "f")]
            });
        };
        this.destroy = () => {
            if (tslib_1.__classPrivateFieldGet(this, _InnerChecker_currentHealthTimeout, "f")) {
        ...
        tslib_1.__classPrivateFieldSet(this, _InnerChecker_healthCallback, healthCallback, "f");
        tslib_1.__classPrivateFieldSet(this, _InnerChecker_requestToSmoldot, (request) => requestToSmoldot((0, util_1.stringify)(request)), "f");
    }
}
...
class HealthCheckError extends Error {
    getCause() {
        return tslib_1.__classPrivateFieldGet(this, _HealthCheckError_cause, "f");
    }
    constructor(response, message = 'Got error response asking for system health') {
        super(message);
        _HealthCheckError_cause.set(this, void 0);
        tslib_1.__classPrivateFieldSet(this, _HealthCheckError_cause, response, "f");
    }
}
